...
parser.add_argument('--root_path', type=str, default=r'splits\acdc', help='Name of Experiment')
parser.add_argument('--data_path', type=str, default=r'D:\datasets\ACDC\ACDC', help='data path')
parser.add_argument('--exp', type=str, default='UNet_CTrans_Conv_LKA', help='experiment_name')
parser.add_argument('--model', type=str, default='UNet_CTrans_Conv_LKA', help='model_name')
...
def Inference(FLAGS):
    ...
    test_save_path = "./save_picture_7/ACDC_{}_{}_labeled/{}_predictions/".format(FLAGS.exp, FLAGS.labelnum, FLAGS.model)
    if os.path.exists(test_save_path):
        shutil.rmtree(test_save_path)
    os.makedirs(test_save_path)
    # net = net_factory(net_type='unet', in_chns=1, class_num=FLAGS.num_classes)
    net = UNet_CTrans_Conv_LKA(in_chns=1, class_num=FLAGS.num_classes)
    net.cuda()
    save_model_path = r'save_7\best.pth'
