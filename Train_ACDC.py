...
parser = argparse.ArgumentParser(description='Semi-supervised medical image segmentation based on coarse-fine dual training streams')
parser.add_argument('--config', type=str, default=r'configs\acdc.yaml')
parser.add_argument('--labeled-id-path', type=str,  default=r'splits\acdc\7\labeled.txt')
parser.add_argument('--unlabeled-id-path', type=str, default=r'splits\acdc\7\unlabeled.txt')
...
def main():
    ...
    # weight_path = r'D:\pycharmproject\UniMatch_ACDC\save_7\best.pth'
    # checkpoint = torch.load(weight_path, map_location='cpu')
    # model_dict = model.state_dict(checkpoint['model'])
    #
    ...
    trainloader_l = DataLoader(trainset_l, batch_size=cfg['batch_size'],
                               pin_memory=True, num_workers=1, drop_last=True, shuffle=False)
    ...
    for epoch in range(epoch + 1, cfg['epochs']):
        ...
        for i, ((img_x, mask_x),
            ...
            # print('pred:' + str(preds.shape))  # [4,4,256,256]
