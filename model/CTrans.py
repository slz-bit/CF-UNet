...
from.CreateKV import KVcreater
...
class Block_ViT(nn.Module):
    def __init__(self, vis, channel_num):
        ...
        self.attn_norm =  LayerNorm(240,eps=1e-6)
...
class ChannelTransformer(nn.Module):
    def __init__(self, vis, img_size, channel_num=[16, 32, 64, 128], patchSize=[64, 32, 16, 8]):
        super().__init__()
